    class tileMap {
        ...
        showExtensions() {
            ...
            score_imag.src = "./images/banana.png"
            ...
            reset_imag.src = "./images/reset.png"
            ctx.drawImage(reset_imag, 800, 40, 80, 50)
            music_imag = new Image()
            music_imag.src = (mute == true) ? "./images/NoMusic.png" : "./images/music.png";
            ctx.drawImage(music_imag, 900, 42, 50, 45)
            let exit_imag = new Image()
            exit_imag.src = "./images/exit.png"
